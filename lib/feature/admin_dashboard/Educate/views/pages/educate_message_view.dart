...
class EducateMessageView extends StatelessWidget {
  final Map<String, dynamic> user;
  const EducateMessageView({super.key, required this.user});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text("Educate Request", style: GoogleFonts.plusJakartaSans(fontSize: 18.sp, fontWeight: FontWeight.w600, color:  AppColors.blackColor)),
            /// DATE
            Text(
